...
<div class="container1">
    <h3 style="text-align: center; ">Reports-Sales</h3>        
     <hr/>
          ...
          for ($i = ($mon-1); $i >= 1; $i--){
              ...
              echo "'".$date->format('F, Y')."'".",";
               if($us == ""){
                 ...
                 $salesdata[] = Stockhistory::get_total_amount($us,$date->format('m'),$date->format('Y'));
                }              
            }
            if($us == ""){
                  // get upcoming for all users
                  ...
                  //get upcomin for just one user
                 $salesdata[] = Stockhistory::get_total_amount($us,date('m'),date('Y'));
                }
            echo "'".date('F, Y')."'" ?>],
        datasets: [{
